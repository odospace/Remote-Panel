...
Requirements
- Install the Adroid APK (RemotePanel.apk) from here https://github.com/odospace/Remote-Panel/blob/main/runtime
- Aida64 version 5.20.3414 or heigher must be installed on the Windows PC.
- Remote Panel (for Windows, RemotePanelSetup.exe) version 1.16 must be installed and running, it can be downloaded with the following link https://github.com/odospace/Remote-Panel/blob/main/runtime 
